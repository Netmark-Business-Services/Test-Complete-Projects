...
supplier_data_file = os.path.join(base_dir, 'Spreadsheet Claims','Ventura Harbor - Waters Edge - TAT', '1-18-25 to 01-24-25 WE claims Master_SD Inv #478.xlsx')
#supplier_data_file = os.path.join(base_dir, 'Spreadsheet Claims', 'Ventura county AAA', 'AAA_mealclaims_May.xlsx')
...
environments = {
    ...
    "Prod": {
        "url": "https://gchp-con-pr01.gchp.local:9193/connector/services/v4/ProfessionalClaim",
        "status_url": "https://gchp-con-pr01.gchp.local:9193/connector/services/v4/ClaimStatusLookup",  # Claim status URL
        "username": "connector",
        "password": "Connector123",
        "req_log_file": os.path.join(base_dir, 'logs', f"{file_name} Claim-Submit-Prod-Requests.txt"),
        "res_log_file": os.path.join(base_dir, 'logs', f"{file_name} Claim-Submit-Prod-Responses.txt "),
    },
}
