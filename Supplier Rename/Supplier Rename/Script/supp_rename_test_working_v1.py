    ...
    while j < 10:
        ...
        if rej_claim_id not in DNU_CLAIM_ID:
            ...
            if reasons == "Supplier could not be identified":
                ...
                if found:
                    ...
                    if supp_to_copy:
                        ...
                        headerGroupHyperLinkEdit.Click(6, 3)
                        #suppppp_name = headerGroupControl.autoSizingPanelSubmittedSupplier.headerGroupControlSubmittedSupplierInfo.SubmittedSupplierInfo.entityPanelSubmittedSupplierInfo.autoEditSubmittedSupplierInfoFullName.panelControlAutoEdit.TextEdit.TextBoxMaskBox.Click(141, 9)
                        suppppp_name = headerGroupControl.autoSizingPanelSubmittedSupplier.headerGroupControlSubmittedSupplierInfo.SubmittedSupplierInfo.entityPanelSubmittedSupplierInfo.autoEditSubmittedSupplierInfoFullName.panelControlAutoEdit.TextEdit.TextBoxMaskBox
                        suppppp_name.Click(141, 9)
                        old_name = str(suppppp_name.wText)
           ...
           #Log.Message(f"submitted claim {rej_claim_id} with supplier id {supplier_id} with address {combinedaddress} " )
                        ...
                        Log.Message(f"Old Name:  {old_name}")
                        Log.Message(f"New Name:  {supp_to_copy}")
...
def paste_supplier_name(supp_to_copy):
    ...
    #headerGroupControl = claimEditor.panelEditClaim.panelControlDetail.panelControlDetailView.Claim.tabControlClaim.tabPageHeader.claimHeader.entityPanel.subEntityPanelConsolidatedInput.panelControlSubscriber.headerGroupProvider.headerGroupControlSubmittedSupplierInformation
    #headerGroupControl.HeaderGroupHyperLinkEdit.Click(131, 10)
